...
@Component({
  selector: 'app-graficas-incidentes',
  templateUrl: './graficas-incidentes.component.html',
  styleUrls: ['./graficas-incidentes.component.css']
})
export class GraficasIncidentesComponent implements OnInit {
